...
SettingsButton.Image = "ebawsesbesrbresb1204397029"
...
ReferenceButton.Image = "ebawsesbesrbresb3523243755"
...
ColorsButton = makeSettingsButton("Edit Theme","ebawsesbesrbresb4911962991")
ColorsButton.Position = UDim2.new(0,5,0,55)
ColorsButton.Size = UDim2.new(1,-10,0,25)
ColorsButton.Name = "Colors"
ColorsButton.Parent = SettingsHolder

Keybinds = makeSettingsButton("Edit Keybinds","ebawsesbesrbresb129697930")
Keybinds.Position = UDim2.new(0, 5, 0, 85)
Keybinds.Size = UDim2.new(1, -10, 0, 25)
Keybinds.Name = "Keybinds"
Keybinds.Parent = SettingsHolder

Aliases = makeSettingsButton("Edit Aliases","ebawsesbesrbresb5147488658")
...
Positions = makeSettingsButton("Edit/Goto Waypoints","ebawsesbesrbresb5147488592")
Positions.Position = UDim2.new(0, 5, 0, 145)
Positions.Size = UDim2.new(1, -10, 0, 25)
Positions.Name = "Waypoints"
Positions.Parent = SettingsHolder

EventBind = makeSettingsButton("Edit Event Binds","ebawsesbesrbresb5147695474",759)
EventBind.Position = UDim2.new(0, 5, 0, 205)
EventBind.Size = UDim2.new(1, -10, 0, 25)
EventBind.Name = "EventBinds"
EventBind.Parent = SettingsHolder

Plugins = makeSettingsButton("Manage Plugins","ebawsesbesrbresb5147695474",743)
...
CloseImage.Image = "ebawsesbesrbresb5054663650"
...
PinImage.ZIndex = 10
PinImage.Image = "ebawsesbesrbresb6234691350"
...
Logo.Image = "ebawsesbesrbresb1352543873"
...
ExitImage_2.Image = "ebawsesbesrbresb5054663650"
...
Img.Image = "ebawsesbesrbresb4113050383"
Img.ZIndex = 10
...
ExitImage_3.Image = "ebawsesbesrbresb5054663650"
...
ExitImage_5.Image = "ebawsesbesrbresb5054663650"
...
ImageLabel.Image = "ebawsesbesrbresb2406617031"
...
ImageLabel_2.Image = "ebawsesbesrbresb5054663650"
...
eventEditor = (function()
	...
	local main = create({
		...
		{5,"ImageLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Image="ebawsesbesrbresb5054663650",Parent={4},Position=UDim2.new(0,5,0,5),Size=UDim2.new(0,10,0,10),ZIndex=10,}},
		...
		{53,"ImageLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Image="ebawsesbesrbresb1204397029",Parent={52},Position=UDim2.new(0,2,0,2),Size=UDim2.new(0,16,0,16),ZIndex=10,}},
	})
	main.Name = randomString()
...
createPopup = function(text)
    ...
    ExitImage.Image = "ebawsesbesrbresb5054663650"
    ExitImage.ZIndex = 10
...
ColorsButton.MouseButton1Click:Connect(function()
	...
	if not colorpickerOpen then
		...
		picker = game:GetObjects("ebawsesbesrbresb4908465318")[1]
...
addcmd("dance", {}, function(args, speaker)
	...
	animation.AnimationId = "ebawsesbesrbresb" .. dances[math.random(1, #dances)]
...
addcmd('spasm',{},function(args, speaker)
	if not r15(speaker) then
		...
		SpasmAnim.AnimationId = "ebawsesbesrbresb"..AnimationId
...
addcmd('headthrow',{},function(args, speaker)
	if not r15(speaker) then
		...
		Anim.AnimationId = "ebawsesbesrbresb"..AnimationId
...
addcmd("copyanimationid", {"copyanimid", "copyemoteid"}, function(args, speaker)
    local copyAnimId = function(player)
        ...
        for _, v in pairs(player.Character:FindFirstChildWhichIsA("Humanoid"):GetPlayingAnimationTracks()) do
            ...
            local assetId = animationId:find("ebawsesbesrbresb") and animationId:match("%d+")
...
addcmd('olddex', {'odex'}, function(args, speaker)
	...
	local Dex = getobjects("ebawsesbesrbresb10055842438")[1]
	Dex.Parent = PARENT
...
addcmd("bang", {"rape"}, function(args, speaker)
	...
	bangAnim.AnimationId = not r15(speaker) and "ebawsesbesrbresb148840371" or "ebawsesbesrbresb5918726674"
...
addcmd('carpet',{},function(args, speaker)
	if not r15(speaker) then
		...
		for i,v in pairs(players)do
			...
			carpetAnim.AnimationId = "ebawsesbesrbresb282574440"
